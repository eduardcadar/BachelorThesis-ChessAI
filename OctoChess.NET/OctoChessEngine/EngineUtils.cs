...
namespace OctoChessEngine
{
    ...
    {
        public static int CHECKMATE_VALUE { get; } = 31800;
        ...
        public static int PieceValue(Piece piece, int file, int rank, GamePhase gamePhase)
        {
            if (piece.Color == PieceColor.WHITE)
                return piece.Type switch
                {
                    ...
                    PieceType.BISHOP
                        => DEFAULT_BISHOP_VALUE + PieceSquareTable.BishopTable[rank][file],
                    PieceType.ROOK => DEFAULT_ROOK_VALUE + PieceSquareTable.RookTable[rank][file],
                    PieceType.QUEEN
                        => DEFAULT_QUEEN_VALUE + PieceSquareTable.QueenTable[rank][file],
                    PieceType.KING
                        => DEFAULT_KING_VALUE
                            + (
                                gamePhase == GamePhase.ENDGAME
                                    ? PieceSquareTable.KingTableEndgame[rank][file]
                                    : PieceSquareTable.KingTable[rank][file]
                            ),
                    _ => 0
                };
            return piece.Type switch
            {
                ...
                PieceType.BISHOP
                    => DEFAULT_BISHOP_VALUE + PieceSquareTable.BishopTableBlack[rank][file],
                PieceType.ROOK => DEFAULT_ROOK_VALUE + PieceSquareTable.RookTableBlack[rank][file],
                PieceType.QUEEN
                    => DEFAULT_QUEEN_VALUE + PieceSquareTable.QueenTableBlack[rank][file],
                PieceType.KING
                    => DEFAULT_KING_VALUE
                        + (
                            gamePhase == GamePhase.ENDGAME
                                ? PieceSquareTable.KingTableBlackEndgame[rank][file]
                                : PieceSquareTable.KingTableBlack[rank][file]
                        ),
                _ => 0
            };
        }
